...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextSelectedColor = getResources().getColor(android.R.color.holo_blue_light);
//        othertabTextSelectedColor = getResources().getColor(R.color.ball_circle_text_color);
       /* tabTextSelectedColor = getResources().getColor(R.color.pstrip_text_selected_color_red);
        ...
        indicatorColor = a.getColor(R.styleable.TabLayout_pstsIndicatorColor, indicatorColor);
        underlineColor = a.getColor(R.styleable.TabLayout_pstsUnderlineColor, underlineColor);
        dividerColor = a.getColor(R.styleable.TabLayout_pstsDividerColor, dividerColor);
        indicatorHeight = a.getDimensionPixelSize(R.styleable.TabLayout_pstsIndicatorHeight, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(R.styleable.TabLayout_pstsUnderlineHeight, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(R.styleable.TabLayout_pstsDividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.TabLayout_pstsTabPaddingLeftRight, tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.TabLayout_pstsTabBackground, tabBackgroundResId);
        shouldExpand = a.getBoolean(R.styleable.TabLayout_pstsShouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(R.styleable.TabLayout_pstsScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(R.styleable.TabLayout_pstsTextAllCaps, textAllCaps);
        a.recycle();
...
//        tabTypeface = Typeface.createFromAsset(getContext().getAssets(),"fonts/scyahei.ttf");
...
//                    }else{
                        tab.setTextColor(tabTextSelectedColor);
//                    }
                    tab .setTypeface(tabTextSelectedSize == 0 ? Typeface.defaultFromStyle(Typeface.NORMAL):Typeface.defaultFromStyle(Typeface.BOLD));
                    //更改字体大小
...
//            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(lineLeft+10, height - indicatorHeight - underlineHeight, lineRight-10, height, rectPaint);
